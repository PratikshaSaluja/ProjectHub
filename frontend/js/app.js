...
async function fetchUserProfile() {
    try {
        ...
        document.getElementById("user-avatar-char").textContent = state.user.full_name[0].toUpperCase();
...
if (editProfileForm) {
    editProfileForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            // Specifically update sidebar text
            ...
            if (avatarCharEl) avatarCharEl.textContent = updatedUser.full_name ? updatedUser.full_name.charAt(0).toUpperCase() : "U";
